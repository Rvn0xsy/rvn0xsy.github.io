...
![添加Shell](https://images.payloads.online/e164371e-4f5e-11ec-93c0-00d861bf4abb.png)

接着为了方便分析，我们为当前条目添加上一个代理，通过`Burp`来分析与服务器端木马的交互数据。

![添加代理](https://images.payloads.online/e19bdd72-4f5e-11ec-8cbf-00d861bf4abb.png)

双击进行连接后，数据包到了我们的Burp中：

![分析数据](https://images.payloads.online/e1d6cf5e-4f5e-11ec-9abf-00d861bf4abb.png)

可以看到已经被`WAF`拦截了：

![拦截截图](https://images.payloads.online/e21c3256-4f5e-11ec-a572-00d861bf4abb.png)

那么我们深知，手工的话是不会被拦截的，为什么呢？

手工截图：

![手工](https://images.payloads.online/e25bcc72-4f5e-11ec-9a98-00d861bf4abb.png)
...
![Success](https://images.payloads.online/e29ddd92-4f5e-11ec-82da-00d861bf4abb.png)

看来已经成功了。

查看进程：

![Command](https://images.payloads.online/e2dc09b4-4f5e-11ec-90be-00d861bf4abb.png)
